    ...
    <Canvas>
        ...
        <div className="pt-20 mx-6">
            <div className="pt-2 relative mx-auto text-gray-600">
                <input className="border-2 border-transparent bg-stone-800 opacity-75 h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none placeholder-white"
                type="search" name="search" placeholder="Search something..." />
